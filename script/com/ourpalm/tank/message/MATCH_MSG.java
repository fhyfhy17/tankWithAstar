...
public final class MATCH_MSG {
  ...
  public interface CTS_TEAM_REQ_MSGOrBuilder
    ...
    // required uint32 friendRoleId = 4;
    /**
     * <code>required uint32 friendRoleId = 4;</code>
     *
     * <pre>
     *被邀请好友角色ID
     * </pre>
    ...
    // required .PROTO_MATCH.WAR_TYPE warType = 5;
    /**
     * <code>required .PROTO_MATCH.WAR_TYPE warType = 5;</code>
     *
     * <pre>
     *战场类型
     * </pre>
  ...
  public static final class CTS_TEAM_REQ_MSG extends
    ...
    // required uint32 friendRoleId = 4;
    public static final int FRIENDROLEID_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeUInt32(4, friendRoleId_);
      }
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeEnum(5, warType_.getNumber());
      }
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, friendRoleId_);
      }
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(5, warType_.getNumber());
      }
      memoizedSerializedSize = size;
      return size;
    }
