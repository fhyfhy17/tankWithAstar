...
/**
 * 一场对应战场整场战斗不死，连杀N个敌人（战场类型或关系）
 * @author Administrator
 *
 */
public class _43_OneBattleAliveContinueKillPhase extends QuestPhase {
	private Set<Integer> warTypeSet;
	private int killCount;
	
	public _43_OneBattleAliveContinueKillPhase(int limit, String param1, String param2) {
		super(limit);
		
		if(isInvalid(param1) || isInvalid(param2)) {
			throw new IllegalArgumentException("创建任务 [一场对应战场整场战斗不死，连杀N个敌人 ] 失败，参数错误");
		}
