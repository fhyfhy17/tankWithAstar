...
public interface AchievementApp extends Service{
	
	AchievementTemplate getTemplate(int achievementId);
	
	List<Achievement> getRoleAchievement(int roleId);
	
	Result drawReward(int roleId, int achievementId);
