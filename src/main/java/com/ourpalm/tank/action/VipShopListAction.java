...
@Command(
	...
	id = SHOP_MSG.CMD_ID.CTS_VIP_SHOP_LIST_VALUE
)
public class VipShopListAction implements Action<Object> {
	...
	public MessageLite execute(ActionContext context, Object reqMsg) {
		...
		RoleShop roleShop = GameContext.getVipShopApp().getShopList(connect.getRoleId());
		if(roleShop == null)
			return null;
