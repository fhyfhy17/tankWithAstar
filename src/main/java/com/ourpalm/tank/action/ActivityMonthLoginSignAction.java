...
@Command(
	...
	id = ACTIVITY_MSG.CMD_ID.CTS_ACTIVITY_MONTHLOGIN_SIGN_VALUE
)
public class ActivityMonthLoginSignAction implements Action<Object> {
	...
	public MessageLite execute(ActionContext context, Object reqMsg) {
		...
		ValueResult<ActivityMonthLoginInfo> result = app.sign(connect.getRoleId());
		if(result.isSuccess()) {
