...
@Command(
	...
	id = SHOP_MSG.CMD_ID.CTS_HONOR_SHOP_LIST_VALUE
)
public class HonorShopListAction implements Action<Object> {
	...
	public MessageLite execute(ActionContext context, Object reqMsg) {
		...
		RoleShop roleShop = GameContext.getHonorShopApp().getShopList(connect.getRoleId());
		if(roleShop == null)
			return null;
