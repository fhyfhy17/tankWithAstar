...
@Command(
	...
	id = SHOP_MSG.CMD_ID.CTS_SHOP_LIST_VALUE
)
public class ShopListAction implements Action<Object> {
	...
	public MessageLite execute(ActionContext context, Object reqMsg) {
		...
		RoleShop roleShop = GameContext.getShopApp().getShopList(connect.getRoleId());
		if(roleShop == null)
			return null;
