...
import com.ourpalm.tank.message.TANK_MSG.CTS_TANK_BUY_MSG;
...
@Command(
	...
	id = TANK_MSG.CMD_ID.CTS_TANK_BUY_VALUE
)
public class TankBuyAction implements Action<CTS_TANK_BUY_MSG>{

	@Override
	public MessageLite execute(ActionContext context, CTS_TANK_BUY_MSG reqMsg) {
		...
		TankBuyResult result = GameContext.getTankApp().tankBuy(roleId, tankId,builder);
		//返回消息
